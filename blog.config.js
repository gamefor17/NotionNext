...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'fuksawa', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://game.17smc.xyz', // 网站地址
